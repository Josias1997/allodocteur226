...
const PackageList = () => {
  ...
  return(
    <div>
        {items.map(item => <div className="card" key={item.name}>
                ...
                <div className="doctor-widget">
                    <div className="doc-info-left">
                        ...
                        <div className="doc-info-cont">
                            <h4 className="doc-name"><Link to="/patient/doctor-profile">{item.name}</Link></h4>
                    ...
                    <div className="doc-info-right">
                        <div className="clinic-booking">
                            <Link onClick={() => setSpeciality(item)} to={"/patient/checkout"} className="apt-btn">Réserver</Link>
                        </div>
                    </div>
                </div>
            </div>
