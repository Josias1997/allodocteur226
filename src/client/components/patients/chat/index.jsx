...
const PatientChat = () => {
	...
	const doctors = useSelector((state) => state.admin.users);
	...
	const [currentDoctors, setCurrentDoctors] = useState(
		doctors.filter((doctor) => doctor.role === "admin")
	);
	...
	const handleSearchInputChange = (event) => {
		...
		if (value === "") {
			return setCurrentDoctors(
				doctors.filter((doctor) => doctor.role === "admin")
			);
		}
		setSearchInput(value);
		console.log("doctors", currentDoctors);
						...
						<div className="call-wrapper">
							<div className="call-inner">
								<div className="call-user">
									...
									/>
									<h4>
										{currentChat?.doctor.firstName}{" "}
										{currentChat?.doctor.lastName}
									</h4>
